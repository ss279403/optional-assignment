...
var mountain = [2000, 1500, 500, 600, 700];
var max = mountain.reduce(function (c, d) {
    return Math.max(c, d);
});
console.log(max);
//Hangman Lite
...
var word = "balloon";
var letter = "B";
var num = word.split(new RegExp(letter, "i")).length - 1;
word.match(/letter/i);
if (num >= 1) {
...
var numOfBirths = (birthRate * numberOfWeeks) + startingPopulation;
...
var reverseWord1 = splitWord1.reverse();
var joinWord2 = reverseWord1.join("");
if (word1 === joinWord2) {
    console.log(true);
}
else {
